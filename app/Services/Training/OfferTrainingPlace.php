...
/** Abstracted to service to consumed from within a Laravel Nova Action. */
class OfferTrainingPlace implements BaseService
{
    ...
    public function __construct(TrainingPosition $trainingPosition, Account $account, Account $offeringAccount, int $expiryHours = 84)
    {
